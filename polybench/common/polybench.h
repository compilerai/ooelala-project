...
#define POLYBENCH_3D_ARRAY_DECL(var, type, dim1, dim2, dim3, ddim1, ddim2,     \
                                ddim3)                                         \
    type POLYBENCH_3D_F(POLYBENCH_DECL_VAR(var), dim1, dim2, dim3, ddim1,      \
                        ddim2, ddim3);                                         \
...
#define POLYBENCH_4D_ARRAY_DECL(var, type, dim1, dim2, dim3, dim4, ddim1,      \
                                ddim2, ddim3, ddim4)                           \
    type POLYBENCH_4D_F(POLYBENCH_DECL_VAR(var), dim1, dim2, dim3, dim4,       \
...
/* unseq-aa "restrict" macros */
#define RESTRICT1(a) (a = a)
#define RESTRICT2(a, b) RESTRICT1(a) + RESTRICT1(b)
#define RESTRICT3(a, b, c) RESTRICT1(a) + RESTRICT2(b, c)
#define RESTRICT4(a, b, c, d) RESTRICT1(a) + RESTRICT3(b, c, d)
#define RESTRICT5(a, b, c, d, e) RESTRICT1(a) + RESTRICT4(b, c, d, e);
#define RESTRICT6(a, b, c, d, e, f) RESTRICT1(a) + RESTRICT5(b, c, d, e, f);

#define GET_MACRO(_1, _2, _3, _4, _5, _6 , NAME, ...) NAME
#define RESTRICT(...) GET_MACRO(__VA_ARGS__, RESTRICT6, RESTRICT5, RESTRICT4, RESTRICT3, RESTRICT2)(__VA_ARGS__)

//
// polybench.c starts here
//
        ...
        if (omp_get_thread_num() == polybench_papi_counters_threadid) {
            ...
            for (k = 0; _polybench_papi_eventlist[k]; ++k) {
                if ((retval = PAPI_event_name_to_code(
                    ...
                    test_fail(__FILE__, __LINE__, "PAPI_event_name_to_code",
                              retval);
            }
